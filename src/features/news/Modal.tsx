...
// Se aplicó el Principio de responsabiliad única, extrayendo lógica del componente en distintos archivos con el fin de dividir responsabilidades en los mismos.
